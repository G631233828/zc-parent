package zhongchiedu.com.canel.listener;
...
public class CanalDataEventListener {
     ...
     * @param rowData
     */
    @ListenPoint(destination = "example", schema = "changgou_user", table = {"tb_brand", "tb_user"}, eventType = CanalEntry.EventType.UPDATE)
