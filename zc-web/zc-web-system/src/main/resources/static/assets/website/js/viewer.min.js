    ...
    var Tt = {
            ...
            load: function() {
                ...
                ct(n, z), e.loading && ct(this.canvas, v), n.style.cssText = "height:0;" + "margin-left:".concat(o.width / 2, "px;") + "margin-top:".concat(o.height / 2, "px;") + "max-width:none!important;position:absolute;width:0;", this.initImage(function() {
                    ut(n, D, e.movable), ut(n, I, e.transition), t.renderImage(function() {
                        t.viewed = !0, t.viewing = !1, et(e.viewed) && wt(i, V, e.viewed, {
                            once: !0
                        }), bt(i, V, {
        ...
        St = {
            show: function(t) {
                ...
                if (et(n.show) && wt(e, W, n.show, {
                        once: !0
                    }), !1 === bt(e, W) || !this.ready) return this;
            ...
            hide: function() {
                ...
                if (et(e.hide) && wt(i, R, e.hide, {
                        once: !0
                    }), !1 === bt(i, R)) return this;
                ...
                if (e.transition && !t) {
                    ...
                    }, this.viewed && ht(this.image, I) ? (wt(this.image, H, o, {
                        once: !0
            ...
            view: function(t) {
                ...
                if (u.src = l, u.alt = c, et(s.view) && wt(n, j, s.view, {
                        once: !0
                    }), !1 === bt(n, j, {
                ...
                }, u.complete ? this.load() : (wt(u, Y, m = this.load.bind(this), {
                    once: !0
            ...
            zoomTo: function(t, i, e, n) {
                ...
                if (G(t = Math.max(0, t)) && this.viewed && !this.played && (r || l.zoomable)) {
                    ...
                    u.width = y, u.height = x, u.ratio = t, this.renderImage(function() {
                        s.zooming = !1, et(l.zoomed) && wt(h, "zoomed", l.zoomed, {
                            once: !0
                        }), bt(h, "zoomed", {
                            ratio: t,
                            oldRatio: D,
            ...
            play: function() {
                ...
                if (this.played = !0, this.onLoadWhenPlay = a, t && this.requestFullscreen(), lt(o, E), nt(this.items, function(t, i) {
                        ...
                        n.src = ft(e, "originalUrl"), n.alt = rt(e.getAttribute("alt")), h += 1, lt(n, b), ut(n, I, s.transition), ht(t, f) && (lt(n, g), l = i), r.push(n), wt(n, Y, a, {
                            once: !0
                        }), o.appendChild(n)
            ...
            full: function() {
                var t = this,
                    ...
                    n = this.image,
                    s = this.list;
                return !this.isShown || this.played || this.fulled || !i.inline || (this.fulled = !0, this.open(), lt(this.button, u), i.transition && (ct(s, I), this.viewed && ct(n, I)), lt(e, y), e.setAttribute("style", ""), at(e, {
                    zIndex: i.zIndex
            ...
            exit: function() {
                var t = this,
                    ...
                    n = this.image,
                    s = this.list;
                return this.isShown && !this.played && this.fulled && i.inline && (this.fulled = !1, this.close(), ct(this.button, u), i.transition && (ct(s, I), this.viewed && ct(n, I)), ct(e, y), at(e, {
            ...
            tooltip: function() {
                ...
                return this.viewed && !this.played && i.tooltip && (e.textContent = "".concat(Math.round(100 * n.ratio), "%"), this.tooltipping ? clearTimeout(this.tooltipping) : i.transition ? (this.fading && bt(e, H), lt(e, E), lt(e, b), lt(e, I), e.offsetWidth, lt(e, g)) : lt(e, E), this.tooltipping = setTimeout(function() {
                    i.transition ? (wt(e, H, function() {
                        ...
                        once: !0
                    }), ct(e, g), t.fading = !0) : ct(e, E), t.tooltipping = !1
                }, 1e3)), this
            },
            toggle: function() {
        ...
        Ct = {
            ...
            shown: function() {
                var t = this.element,
                    i = this.options;
                this.fulled = !0, this.isShown = !0, this.render(), this.bind(), this.showing = !1, et(i.shown) && wt(t, P, i.shown, {
                    once: !0
                }), !1 !== bt(t, P) && this.ready && this.isShown && !this.hiding && this.view(this.index)
            },
            hidden: function() {
                var t = this.element,
                    i = this.options;
                this.fulled = !1, this.viewed = !1, this.isShown = !1, this.close(), this.unbind(), lt(this.viewer, k), this.resetList(), this.resetImage(), this.hiding = !1, this.destroyed || (et(i.hidden) && wt(t, N, i.hidden, {
                    once: !0
                }), bt(t, N))
            },
            ...
            return function(t, i, e) {
                ...
                value: function() {
                    if (!this.ready) {
                        ...
                        if (h.inline) lt(r, x), at(n, {
                            zIndex: h.zIndexInline
                        }), "static" === window.getComputedStyle(i).position && at(i, {
                            position: "relative"
                        }), i.insertBefore(n, t.nextSibling);
                        else {
                            lt(r, w), lt(n, y), lt(n, b), lt(n, k), at(n, {
                                zIndex: h.zIndex
                            });
                            var v = h.container;
                            $(v) && (v = t.ownerDocument.querySelector(v)), (v = v || this.body).appendChild(n)
                        }
                        h.inline && (this.render(), this.bind(), this.isShown = !0), this.ready = !0, et(h.ready) && wt(t, O, h.ready, {
                            once: !0
                        }), !1 !== bt(t, O) ? this.ready && h.inline && this.view(this.index) : this.ready = !1
                    }
                }
            }], [{
                key: "noConflict",
