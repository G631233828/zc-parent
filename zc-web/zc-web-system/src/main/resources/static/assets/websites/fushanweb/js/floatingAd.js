            ...
            $(img).attr("src", src).load(function() {
                ...
                _this.options = $.extend({},
                    ...
                    options, {
                        ...
                        xPos: _this.getRandomNum(0, $(window).width() - $(element).innerWidth()),
                        yPos: _this.getRandomNum(0, 300),
                        yOn: _this.getRandomNum(0, 1),
                        xOn: _this.getRandomNum(0, 1),
                        yPath: _this.getRandomNum(0, 1),
                        xPath: _this.getRandomNum(0, 1),
                        hOffset: ih,
                        wOffset: iw,
                        fn: function() {},
                        interval: 0
